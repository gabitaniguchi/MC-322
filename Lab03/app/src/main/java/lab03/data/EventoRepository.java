...
/**
 * Repositório responsável por definir e fornecer a lista de eventos disponíveis.
 */
public class EventoRepository {

    /**
     * Cria e retorna uma lista de eventos com dados seus respectivos dados, incluindo locais e organizadoras.
     * @return uma lista observável contendo os eventos cadastrados
     */
    public static ObservableList<Evento> definirEventos() {
        ...
        Organizadora organizadora2 = new Organizadora("Time For Fun (T4F)", 12345, "Faria Lima");
        
        Local localFestival = new Local("Autódromo de Interlagos", 300000);
        ...
        eventos.add(new Evento("Lollapalooza Brasil 2025", localFestival, 200.0, organizadora2, "27/09/2025"));
        eventos.add(new Evento("Noite de Karaoke", localBar, 25.0, organizadora2, "20/08/2025"));
        eventos.add(new Evento("Final da Copa do Brasil", localJogo, 250.0, organizadora2, "30/09/2025"));
        eventos.add(new Evento("Concerto Clássico", localTeatro, 50.0, organizadora, "01/06/2025"));
        eventos.add(new Evento("Show Coldplay Live in São Paulo", localShow, 400.0, organizadora2, "15/11/2025"));
        ...
        eventos.add(new Evento("Final do Masterchef", localMasterchef, 100.0, organizadora2, "20/12/2025"));
        eventos.add(new Evento("GameCon Brasil 2025", localGameCon, 80.0, organizadora2, "27/11/2026"));
