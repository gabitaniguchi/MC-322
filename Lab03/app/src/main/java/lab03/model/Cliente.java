...
public class Cliente implements Comparable<Cliente>{
    ...
    /**
     * Exceção referente a quando o cliente tenta vender um ingresso que não possui
     * Se o cliente não possui o ingresso, lança uma exceção
     */
    ...
    /**
     * Exceção referente a oferta não existente na lista de ofertas do marketplace
     * Se a oferta não for encontrada, lança uma exceção
     */
    ...
    /**
     * Exceção referente ao saldo insuficiente para comprar o ingresso
     * Se o saldo é insuficiente, lança uma exceção
     */
    ...
    /**
     * Oferece um ingresso do cliente para venda no marketplace.
     * Remove o ingresso da lista de ingressos do cliente após a oferta.
     * @param ingresso o ingresso a ser oferecido para venda
     * @param precoPedido o preço desejado pelo ingresso
     * @param marketplace o marketplace onde a oferta será registrada
     */
    ...
    /**
     * Permite ao cliente comprar um ingresso ofertado no marketplace.
     * Verifica se a oferta existe e se o cliente tem saldo suficiente.
     * @param oferta a oferta de ingresso a ser comprada
     * @param marketplace o marketplace onde a compra será processada
     */
    ...
    /**
     * Permite ao cliente comprar um ingresso oficial (não vindo de outro cliente).
     * Verifica se o cliente possui saldo suficiente antes da compra.
     * @param oferta a oferta oficial contendo o ingresso e o preço
     */
