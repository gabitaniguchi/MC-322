...
public abstract class Evento {
    ...
    * @param precoIngresso o precço do ingresso associado ao Evento
    */
    ...
    */
    ...
    /**
     * Retorna a lista e imprime o número dos ingressos vendidos
    * @return lista ingressos vendidos
    */
    public List<Ingresso> getIngressosVendidos(){
    
    System.out.println("Ingressos vendidos: " + ingressosVendidos.size());
